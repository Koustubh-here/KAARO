...
export async function fuzzyFindProducts(businessId, query, maxResults = 5) {
  return supabase
    .rpc('search_products', { p_business: businessId, q: query, max_results: maxResults })
    .select();
}

// Conversations (hooks for future usage)
